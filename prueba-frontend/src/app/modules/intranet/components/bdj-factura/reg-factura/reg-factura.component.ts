...
@Component({
  ...
  styleUrls: ['./reg-factura.component.scss']
})
export class RegFacturaComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    public dialogRef: MatDialogRef<RegFacturaComponent>,
  ...
  regFactura(): void {
    if (this.formularioGrp.valid && this.formularioDetGrp.valid) {
      if (this.cliente) {
        ...
        req.nomCliente = this.cliente.nombre + ' ' + this.cliente.apellidoPat + ' ' + this.cliente.apellidoMat;
        req.flgActivo = 1;
